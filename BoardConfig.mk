...
-include vendor/sky/sky4d/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := sky4d
...
BOARD_CUSTOM_BOOTIMG_MK := device/sky/sky4d/bootimg.mk
BOARD_MKBOOTIMG_ARGS := --mtk 1

TARGET_PREBUILT_KERNEL := device/sky/sky4d/prebuilt/kernel
TARGET_RECOVERY_INITRC := device/sky/sky4d/recovery/init.mt6572.rc
TARGET_RECOVERY_FSTAB := device/sky/sky4d/recovery/recovery.fstab
